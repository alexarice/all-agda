...
let
  ...
  primaryVersion = if versions == [] then null else lib.last (lib.naturalSort versions);
in if primaryVersion == null then null else set."${primaryVersion}" // set // { isLibrarySet = true; }
